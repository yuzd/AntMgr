        ...
        return new Promise(function (resolve, reject) {
            ...
            var confirm = function confirm(value) {
                ...
                if (params.preConfirm) {
                    var p = params.preConfirm(value, params.extraParams);
                    if (p) {
                        p.then(function (preConfirmValue) {
                            sweetAlert.closeModal(params.onClose);
                            resolve(preConfirmValue || value);
                        }, function (error) {
                            sweetAlert.hideLoading();
                            if (error && error.showValidationError) {
                                sweetAlert.showValidationError(error.Info);
                            }
                        });
                    }
                } else {
...
if (window.Sweetalert2) window.Sweetalert2 = window.swal = window.Sweetalert2;